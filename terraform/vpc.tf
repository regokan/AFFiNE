# =============================================================================
# AFFiNE AWS Terraform - VPC & Networking
# =============================================================================
...
# Private subnets for RDS (need 2 for DB subnet group)
...
resource "aws_security_group" "ec2" {
  ...
  # HTTPS (for future use with ALB/Nginx)
  ingress {
    description = "HTTPS"
    from_port   = 443
    to_port     = 443
...
resource "aws_security_group" "rds" {
  ...
  description = "Security group for AFFiNE RDS PostgreSQL"
  vpc_id      = aws_vpc.main.id
